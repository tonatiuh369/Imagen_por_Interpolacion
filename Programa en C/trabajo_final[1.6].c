...
float h[100], FPO=-1.596, FPN=5.26, alfa[100],l[100],m[100];
float z[100],a[100],c[100],b[100],d[100],S[100],x;

/* ENTRADA VALORES DE X1 y Y1 */
float X1[100]={-5.26,-5.19,-5.15,-5.10,-5.07,-5.05,-5.02,-5.01};
float Y1[100]={2.45,2.41,2.39,2.37,2.375,2.38,2.39,2.44};
...
/* Abrir Archivo */
FILE *Resultados;
Resultados = fopen("snoopy[1.6].dat", "w");
