...
float h[100], FPO=1, FPN=0.01, alfa[100],l[100],m[100];
float z[100],a[100],c[100],b[100],d[100],S[100],x;


/* ENTRADA VALORES DE X1 y Y1 */
float X1[100]={-0.54,-0.45,-0.33,-0.20};
float Y1[100]={3.14,3.22,3.27,3.28};
...
/* Abrir Archivo */
FILE *Resultados;
Resultados = fopen("snoopy[2.9].dat", "w");
