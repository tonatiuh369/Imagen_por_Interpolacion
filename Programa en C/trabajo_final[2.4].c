...
float h[100], FPO=-1.596, FPN=-0.7, alfa[100],l[100],m[100];
float z[100],a[100],c[100],b[100],d[100],S[100],x;

/* ENTRADA VALORES DE X1 y Y1 */
float X1[100]={-1.57,-1.54,-1.43,-1.26};
float Y1[100]={1.87,1.80,1.61,1.36};
...
/* Abrir Archivo */
FILE *Resultados;
Resultados = fopen("snoopy[2.4].dat", "w");
