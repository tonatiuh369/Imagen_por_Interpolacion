...
float h[100], FPO=-7.57, FPN=2.08, alfa[100],l[100],m[100];
float z[100],a[100],c[100],b[100],d[100],S[100],x;

/* ENTRADA VALORES DE X1 y Y1 */
float X1[100]={-5.21,-5.20,-5.13,-5.03,-5.005};
float Y1[100]={2.81,2.78,2.76,2.76,2.79};
...
/* Abrir Archivo */
FILE *Resultados;
Resultados = fopen("snoopy[1.8].dat", "w");
