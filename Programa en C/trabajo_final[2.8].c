...
float h[100], FPO=20, FPN=0.01, alfa[100],l[100],m[100];
float z[100],a[100],c[100],b[100],d[100],S[100],x;

/* ENTRADA VALORES DE X1 y Y1 */
float X1[100]={-0.81,-0.80,-0.77,-0.73,-0.70,-0.68,-0.65,-0.60,-0.56,-0.47,-0.34};
float Y1[100]={2.62,2.70,3.00,3.24,3.30,3.36,3.40,3.47,3.49,3.52,3.55};
...
/* Abrir Archivo */
FILE *Resultados;
Resultados = fopen("snoopy[2.8].dat", "w");
