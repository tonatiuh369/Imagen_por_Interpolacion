...
float h[100], FPO=-1.3, FPN=-20, alfa[100],l[100],m[100];
float z[100],a[100],c[100],b[100],d[100],S[100],x;

/* ENTRADA VALORES DE X1 y Y1 */
float X1[100]={-1.49,-1.43,-1.21,-1.15,-1.08,-1.06};
float Y1[100]={1.94,1.89,1.66,1.55,1.39,1.22};
...
/* Abrir Archivo */
FILE *Resultados;
Resultados = fopen("snoopy[2.5].dat", "w");
