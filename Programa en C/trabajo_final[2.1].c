...
float h[100], FPO=5.26, FPN=-11, alfa[100],l[100],m[100];
float z[100],a[100],c[100],b[100],d[100],S[100],x;

/* ENTRADA VALORES DE X1 y Y1 */
float X1[100]={-4.94,-4.89,-4.79,-4.73,-4.70,-4.68,-4.66,-4.65};
float Y1[100]={1.84,1.98,2.04,2.03,2.01,1.99,1.89,1.81};
...
/* Abrir Archivo */
FILE *Resultados;
Resultados = fopen("snoopy[2.1].dat", "w");
