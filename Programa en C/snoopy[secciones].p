...
set style line 1 lt -1 lw 5       #Se definen los estilos de línea a utilizar
set style line 3 lt 1 lw 5 
set style line 4 lt 2 lw 5 
set style line 5 lt 3 lw 5 
set style line 6 lt 4 lw 5 
set style line 7 lt 5 lw 5 
set style line 8 lt 6 lw 5 
set style line 9 lt 7 lw 5 
set style line 10 lt 8 lw 5 


set style line 2 lt -1 pt 4 ps 1   # pt: 1 cruz +, 2 cruz X, 4 cuadrado hueco, 5 cuadrado relleno,
				  # 6 circunferencia, 7 circulo, 12 rombo hueco, 13 rombo relleno.


# DIBUJANDO LA GRAFICA
# plot archivo usando las columnas 1 y 2 con titulo y con lineas
plot "snoopy[1.1].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 5, \
     "snoopy[1.2].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 3, \
     "snoopy[1.3].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 4, \
     "snoopy[1.4].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 5, \
     "snoopy[1.5].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 6, \
     "snoopy[1.6].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 7, \
     "snoopy[1.7].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 4, \
     "snoopy[1.8].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 5, \
     "snoopy[1.9].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 9, \
     "snoopy[2.0].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 7, \
     "snoopy[2.1].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 9, \
     "snoopy[2.2].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 4, \
     "snoopy[2.3].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 5, \
     "snoopy[2.4].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 6, \
     "snoopy[2.5].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 7, \
     "snoopy[2.6].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 9, \
     "snoopy[2.7].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 9, \
     "snoopy[2.8].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 3, \
     "snoopy[2.9].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 9, \
     "snoopy[3.0].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 3, \
     "snoopy[3.1].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 4, \
     "snoopy[3.2].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 9, \
     "snoopy[3.3].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 6, \
     "snoopy[3.4].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 7, \
     "snoopy[3.5][FINAL].dat" index 0:0 using 1:2 title "S(x)" with lines linestyle 9, \
...
set output "snoopy[completo 1.1][colores].png" # La salida al fichero.png
