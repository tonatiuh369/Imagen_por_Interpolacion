...
float h[100], FPO=0.5, FPN=-10, alfa[100],l[100],m[100];
float z[100],a[100],c[100],b[100],d[100],S[100],x;


/* ENTRADA VALORES DE X1 y Y1 */
float X1[100]={-2.00,-1.85,-1.71,-1.65,-1.60,-1.58,-1.56,-1.55};
float Y1[100]={3.37,3.44,3.47,3.45,3.42,3.39,3.35,3.31};
...
/* Abrir Archivo */
FILE *Resultados;
Resultados = fopen("snoopy[3.2].dat", "w");
