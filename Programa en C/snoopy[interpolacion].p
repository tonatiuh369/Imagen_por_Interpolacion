#########################################
# SCRIPT para GNUPLOT, Archivo llamado "snoopy[completo 1.1].p" para unir todas las partes de la imagen

# Para activar este postscript escribir en la terminal: gnuplot snoopy[completo 1.1].p (despues de tener todos los archivos .dat )
##########################################
...
set style line 1 lt 6 lw 5     #Se definen los estilos de línea a utilizar
set style line 2 lt 5 pt 7 ps 1 
...
set output "snoopy[completo 1.1].png" # La salida al fichero.png
replot # volver a graficar

set terminal postscript color solid # Poniendo la salida (terminal) en postscript y a color
set output "snoopy[completo 1.1].ps" # Dirigir la salida al archivo .ps
