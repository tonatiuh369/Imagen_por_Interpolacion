...
float h[100], FPO=0.93, FPN=-9.26, alfa[100],l[100],m[100];
float z[100],a[100],c[100],b[100],d[100],S[100],x;

/* ENTRADA VALORES DE X1 y Y1 */
float X1[100]={-5.21,-5.18,-5.13,-5.08,-5.05,-5.03,-5.01,-5.005};
float Y1[100]={2.81,2.85,2.85,2.84,2.83,2.825,2.82,2.79};
...
/* Abrir Archivo */
FILE *Resultados;
Resultados = fopen("snoopy[1.9].dat", "w");
