...
float h[100], FPO=0.5, FPN=1.3, alfa[100],l[100],m[100];
float z[100],a[100],c[100],b[100],d[100],S[100],x;

/* ENTRADA VALORES DE X1 y Y1 */
float X1[100]={-1.14,-1.09,-1.06};
float Y1[100]={1.16,1.19,1.22};
...
/* Abrir Archivo */
FILE *Resultados;
Resultados = fopen("snoopy[2.6].dat", "w");
