...
float h[100], FPO=0.1, FPN=9.09, alfa[100],l[100],m[100];
float z[100],a[100],c[100],b[100],d[100],S[100],x;

/* ENTRADA VALORES DE X1 y Y1 */
float X1[100]={-4.16,-4.04,-3.89,-3.77,-3.71,-3.69,-3.67,-3.66,-3.62,-3.61};
float Y1[100]={1.58,1.61,1.68,1.90,1.99,2.03,2.07,2.16,2.25,2.30};
...
/* Abrir Archivo */
FILE *Resultados;
Resultados = fopen("snoopy[1.4].dat", "w");
