...
float h[100], FPO=0.667, FPN=-1.75, alfa[100],l[100],m[100];
float z[100],a[100],c[100],b[100],d[100],S[100],x;

/* ENTRADA VALORES DE X1 y Y1 */
float X1[100]={-5.26,-5.23,-5.05,-5.01};
float Y1[100]={2.45,2.47,2.47,2.44};
...
/* Abrir Archivo */
FILE *Resultados;
Resultados = fopen("snoopy[1.7].dat", "w");
