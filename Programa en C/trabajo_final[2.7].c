...
/*  +++ Trabajo Final +++
    ...
    <<< PATA izquierda (parte izquierda) >>>
...
float h[100], FPO=0.154, FPN=0.154, alfa[100],l[100],m[100];
float z[100],a[100],c[100],b[100],d[100],S[100],x;

/* ENTRADA VALORES DE X1 y Y1 */
float X1[100]={-1.14,-0.81};
float Y1[100]={2.64,2.70};
...
/* Abrir Archivo */
FILE *Resultados;
Resultados = fopen("snoopy[2.7].dat", "w");
